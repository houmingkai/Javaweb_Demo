package com.hmk.javaweb.jfreechart;
...
public class TestJFreeChart {
    ...
    public static JFreeChart createChart(CategoryDataset categoryDataset) {
        ...
        JFreeChart jfreechart = ChartFactory.createLineChart("line.jpg", // 标题
                "year", // categoryAxisLabel （category轴，横轴，X轴标签）
                "count", // valueAxisLabel（value轴，纵轴，Y轴的标签）
