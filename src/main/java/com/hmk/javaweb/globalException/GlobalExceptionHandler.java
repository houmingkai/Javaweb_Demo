package com.hmk.javaweb.globalException;
...
//        return resultFormat(2, ex);
        return new ReturnMessage(false,"空指针异常",ex.getMessage());
    }
    ...
    public ReturnMessage indexOutOfBoundsExceptionHandler(IndexOutOfBoundsException ex) {
//        return resultFormat(6, ex);
        return new ReturnMessage(false,"数组越界异常",ex.getMessage());
    }

    @ExceptionHandler(NoHandlerFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ReturnMessage noHandlerFoundHandler(NoHandlerFoundException ex) {
        ...
        return new ReturnMessage(false, "404错误(请求地址不存在)",ex.getMessage());
    }
